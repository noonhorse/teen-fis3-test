/* Zepto v1.1.2 - zepto event ajax form ie detect fx fx_methods assets data deferred callbacks selector touch gesture stack ios3 -license */
...
if("undefined"==typeof DOMAIN_PATH||!DOMAIN_PATH) var DOMAIN={};
DOMAIN.CONFIG = {
	jsPath:"http://js.qiku.com",
	cssPath:"http://css.qiku.com",
	imagePath:"http://res.qiku.com",
	resPath:"http://res.qiku.com",
    wwwPath:"http://www.qiku.com",
    gspPath:"http://grap.qiku.com",//GRAP
    gsrPath:"http://po.qiku.com",
    godPath:"http://god.qiku.com",
    gosPath:"http://mypo.qiku.com",
    cartPath:"http://cart.qiku.com",
    itemPath:"http://item.qiku.com",
    setPath:"http://set.qiku.com",
    rcPath:"http://rc.qiku.com",
    hdPath:"http://hd.qiku.com",
    statPath:"http://stat.qiku.com",
    domainPath:".qiku.com",
    domainDazenPath:".dazen.cn",
    bbsPath:"http://bbs.qiku.com",
    payPath:"http://pay.qiku.com",
    coolyunPath:"https://passport.coolyun.com",
    checktokenPath:"http://usermgr.coolyun.com/UserManage/check_accesstoken"
};
function getPath(type){
	return DOMAIN.CONFIG[type+"Path"];
}